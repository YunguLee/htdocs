...
<link rel="stylesheet" type="text/css" href="./KCC공지사항_files/kcc.css">
<link rel="stylesheet" type="text/css" href="./KCC공지사항_files/rubyadd.css">
<link rel="stylesheet" type="text/css" href="./KCC공지사항_files/jquery-ui-1.9.2.min.css">


<script src="./kccpost/jquery-1.8.3.min.js.다운로드"></script>
<script src="./kccpost/jquery-ui-1.9.2.min.js.다운로드"></script>
<script src="./kccpost/jquery.jqtransform.js.다운로드"></script>
<script src="./kccpost/common.js.다운로드"></script>
<script src="./kccpost/jquery.form.js.다운로드"></script>
<script src="./kccpost/kccgolf.js.다운로드"></script>
<script src="./kccpost/jquery.ui.datepicker-ko.js.다운로드"></script>
			...
			<div class="cont_r">
				...
				<div class="comm_wrap">
					...
					<tbody>
                        ...
                        {
                            echo "<tr>":
                            echo "<td> <div class='in'>".$row['idx']."</div> </td>";
                            echo "<td class='con'> <div class='in'><a href='#'>".$row['title']."</a></div></td>";
                            echo "<td> <div class='in'> <div class='in'>".row['day']."</div></div></td>";
                            echo "<td> <div class='in'> <div class='in'>".row['viecount']."</div></div></td>";
                            echo "</tr>";
                        }
                        ?>
