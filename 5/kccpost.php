...
<link rel="stylesheet" type="text/css" href="./kccpost/kcc.css">
<link rel="stylesheet" type="text/css" href="./kccpost/rubyadd.css">
<link rel="stylesheet" type="text/css" href="./kccpost/jquery-ui-1.9.2.min.css">
			...
			<div class="cont_r">
				...
				<div class="comm_wrap">
					...
					<tbody>
                        ...
                        {
                            echo "<tr>";
                                echo "<td> <div class='in'>";
                                print $row['idx'];
                                echo "</div> </td>";
                                echo "<td class='con'> <div class='in'><a href='#'>";
                                print $row['title'];
                                echo "</a></div></td>";
                                echo "<td> <div class='in'> <div class='in'>";
                                print $row['day'];
                                echo "</div></div></td>";
                                echo "<td> <div class='in'> <div class='in'>";
                                print $row['viecount'];
